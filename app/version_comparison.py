...
class LCPVersionComparator:
    ...
    def __init__(self, s3_manager):
        ...
        self.level2_toc = [
            ...
            { 'id': '3.2', 'top_id': '3', 'label': 'Subjective History' },
            { 'id': '3.2.1', 'top_id': '3', 'label': 'Current Symptoms' },
            { 'id': '3.2.2', 'top_id': '3', 'label': 'Physical Symptoms' },
            { 'id': '3.2.3', 'top_id': '3', 'label': 'Functional Symptoms' },
            { 'id': '3.3', 'top_id': '3', 'label': 'Review of Systems' },
            { 'id': '3.3.1', 'top_id': '3', 'label': 'Emotional Symptoms' },
            { 'id': '3.3.2', 'top_id': '3', 'label': 'Neurologic' },
            { 'id': '3.3.3', 'top_id': '3', 'label': 'Orthopedic' },
            { 'id': '3.3.4', 'top_id': '3', 'label': 'Cardiovascular' },
            { 'id': '3.3.5', 'top_id': '3', 'label': 'Integumentary' },
            { 'id': '3.3.6', 'top_id': '3', 'label': 'Respiratory' },
            { 'id': '3.3.7', 'top_id': '3', 'label': 'Digestive' },
            { 'id': '3.3.8', 'top_id': '3', 'label': 'Urinary' },
            { 'id': '3.3.9', 'top_id': '3', 'label': 'Circulation' },
            { 'id': '3.3.10', 'top_id': '3', 'label': 'Behavioral' },
            { 'id': '3.4', 'top_id': '3', 'label': 'Past Medical History' },
            { 'id': '3.5', 'top_id': '3', 'label': 'Past Surgical History' },
            { 'id': '3.6', 'top_id': '3', 'label': 'Injections' },
            { 'id': '3.7', 'top_id': '3', 'label': 'Family History' },
            { 'id': '3.8', 'top_id': '3', 'label': 'Allergies' },
            { 'id': '3.9', 'top_id': '3', 'label': 'Drug and Other Allergies' },
            { 'id': '3.10', 'top_id': '3', 'label': 'Medications' },
            { 'id': '3.11', 'top_id': '3', 'label': 'Assistive Device' },
            { 'id': '3.12', 'top_id': '3', 'label': 'Social History' },
            { 'id': '3.13', 'top_id': '3', 'label': 'Education History' },
            { 'id': '3.14', 'top_id': '3', 'label': 'Professional/Work History' },
            { 'id': '3.15', 'top_id': '3', 'label': 'Habits' },
            { 'id': '3.16', 'top_id': '3', 'label': 'Tobacco use' },
            { 'id': '3.17', 'top_id': '3', 'label': 'Alcohol use' },
            { 'id': '3.18', 'top_id': '3', 'label': 'Illicit drugs' },
            { 'id': '3.19', 'top_id': '3', 'label': 'Avocational Activities' },
